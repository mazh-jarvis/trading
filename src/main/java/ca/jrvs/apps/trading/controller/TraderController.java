...
public class TraderController {
    ...
    @ApiOperation(value = "Update a an existing account")
    @ResponseStatus(HttpStatus.ACCEPTED)
    @ResponseBody
    @PutMapping(path = "/trader/deposit/accountId/{accountId}/amount/{amount}", produces = {MediaType.APPLICATION_JSON_UTF8_VALUE})
    public void updateTrader(@PathVariable int accountId, @PathVariable double amount) {
        try {
            fundService.deposit(accountId, amount); // "TraderId and AccountId are auto generated by the database, and they should be identical"
        } catch (Exception e) {
            throw ResponseExceptionUtil.getResponseStatusException(e);
        }
    }
