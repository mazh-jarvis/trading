...
public class TraderController {
    ...
    @ResponseBody
    @PutMapping(path = "/trader/deposit/accountId/{accountId}/amount/{amount}", produces = {MediaType.APPLICATION_JSON_UTF8_VALUE})
    ...
    @ResponseStatus(HttpStatus.ACCEPTED)
    @ResponseBody
    @PutMapping(path = "/trader/withdraw/accountId/{accountId}/amount/{amount}", produces = {MediaType.APPLICATION_JSON_UTF8_VALUE})
    ...
    @ResponseStatus(HttpStatus.ACCEPTED)
    @DeleteMapping(path = "/trader/traderId/{traderId}")
